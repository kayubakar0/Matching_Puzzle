...
namespace _2048FALLING
{
    public class GameBroadManager : MonoBehaviour
    {
        ...
        // codingan untuk mengatur gerakan
                    ...
                    case MoveDirection.Right:
                        {
                            ...
                            if (AllTiles[isRow, isCol].Number == 0 || AllTiles[isRow, isCol].Number == -1)
                                AllTiles[isRow, isCol].Number = numberData;     // bisa gerak ke kanan
                            else                                                // gak bisa gerak karena ada isinya
                    ...
                    case MoveDirection.Left:
                        {
                            ...
                            if (AllTiles[isRow, isCol].Number == 0 || AllTiles[isRow, isCol].Number == -1)
                                AllTiles[isRow, isCol].Number = numberData;     // bisa gerak ke kiri
                            else                                                // gak bisa gerak karena ada isinya
                                AllTiles[isRow, ++isCol].Number = numberData;
